  ...
  return (
    <DismissKeyboard>
      <>
        ...
        >
          <Filter placeholder="Beds" keyboardType={"number-pad"} />
          <Filter placeholder="Bedrooms" keyboardType={"number-pad"} />
          <Filter placeholder="Bathrooms" keyboardType={"number-pad"} />
          <Filter placeholder="Max. price" keyboardType={"number-pad"} />
          <Filter placeholder="Min. price" keyboardType={"number-pad"} />
        </FiltersContainer> */}
        </Container>
